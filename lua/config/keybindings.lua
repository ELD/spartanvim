...
keymap({ "n", "t" }, "<A-h>", function() require "dap".continue() end, { silent = true, desc = "step out" })
keymap({ "n", "t" }, "<A-k>", function() require("dap.ui.widgets").hover() end, { silent = true, desc = "calculate expr" })
keymap("n", "<F5>", function() require "dap".stepout() end, { silent = true, desc = "toggle breakpoint" })
